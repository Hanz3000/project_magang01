    ...
    <div class="w-full max-w-5xl space-y-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                ...
                <form action="{{ route('dashboard') }}" method="GET" class="mt-3 md:mt-0 flex-shrink-0 w-full md:w-auto md:inline-flex space-x-2">
                    <!-- Pencarian -->
                    <input type="text" name="search" value="{{ request('search') }}" class="flex-grow md:w-64 border border-gray-300 px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent text-sm" placeholder="Cari nama barang...">
                    <!-- Sortir -->
                    ...
                    <!-- Tombol -->
                    <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 text-sm flex items-center justify-center">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tanggal Keluar</th> <!-- Tambahkan ini -->
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $item['jumlah'] ?? '0' }}</td>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500 align-middle" style="height: 200px;">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 mt-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <form action="{{ route('dashboard') }}" method="GET" class="mt-3 md:mt-0 flex-shrink-0 w-full md:w-auto md:inline-flex space-x-2">
                    <input type="text" name="search_pengeluaran" value="{{ request('search_pengeluaran') }}" class="flex-grow md:w-64 border border-red-300 px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-transparent text-sm" placeholder="Cari nama barang pengeluaran...">
                    ...
                    <button type="submit" class="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 text-sm flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                        </svg>
                        Cari
