                        ...
                        <tbody class="divide-y divide-gray-200">
                            @forelse ($pengeluarans as $index => $pengeluaran)
                                <tr class="hover:bg-gray-50 transition-colors animate-fadeIn">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-gray-900">{{ $pengeluaran->income_tanggal_formatted }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            <form action="{{ route('pengeluarans.destroy', $pengeluaran->id) }}"
                                                ...
                                                @method('DELETE')
                                                <button type="button"
                                                    onclick="openDeleteModal('{{ route('pengeluarans.destroy', $pengeluaran->id) }}')"
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">Apakah Anda yakin ingin menghapus data pengeluaran ini?
                                </p>
                            </div>
                        </div>
                    </div>
