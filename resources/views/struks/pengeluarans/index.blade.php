                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex flex-col items-center">
                                            ...
                                            @php
                                                ...
                                                // Cek bukti di pengeluaran langsung
                                                if ($pengeluaran->bukti_pembayaran) {
                                                    $imagePath = 'storage/' . $pengeluaran->bukti_pembayaran;
                                                    $source = 'pengeluaran';
                                                }
                                                // Cek dari struk terkait
                                                elseif ($pengeluaran->struk && $pengeluaran->struk->foto_struk) {
                                                    $imagePath =
                                                        'storage/struk_foto/' . $pengeluaran->struk->foto_struk;
                                                    $source = 'struk';
                                                }
                                            @endphp
                                            ...
                                            @if ($pengeluaran->income)
                                                <div class="text-xs text-center bg-green-50 p-2 rounded-lg">
                                                    ...
                                                    <p>Total: Rp
                                                        {{ number_format($pengeluaran->income->total_harga ?? 0, 0, ',', '.') }}
                                                    </p>
                                                    <p>Barang:
                                                        {{ $pengeluaran->income->items ? count(json_decode($pengeluaran->income->items, true)) : 0 }}
                                                        item</p>
                                                </div>
                                            @endif
                                        </div>
