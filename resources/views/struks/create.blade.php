            ...
            <form action="{{ route('struks.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="file-upload-container" onclick="document.getElementById('foto_struk').click()"
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-600">Klik untuk upload foto struk</p>
                        <p class="text-sm text-gray-500 mt-2">Maksimal 5MB • JPG, PNG</p>
                    </div>
                </div>
                ...
                <div class="file-preview" id="file-preview">
                    ...
                    <div class="mt-3 flex justify-between items-center">
                        ...
                        <button type="button" onclick="hapusFoto()" class="text-red-500 hover:text-red-700">
