                ...
                <div class="flex flex-wrap gap-2 w-full sm:w-auto items-center">
                    ...
                    <div class="flex items-center gap-2 mt-2 sm:mt-0">
                        <div class="relative inline-block w-12 align-middle select-none">
                            ...
                            <label for="toggle-struk" title="Lihat Data Pengeluaran" class="block h-6 rounded-full cursor-pointer transition-colors duration-300 ease-in-out {{ $isPemasukan ? 'bg-indigo-400' : 'bg-gray-300' }}">
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left font-medium text-gray-500 uppercase tracking-wider">No. SPK</th>
                            ...
                            <th class="px-6 py-3 text-center font-medium text-gray-500 uppercase tracking-wider">SPK</th>
