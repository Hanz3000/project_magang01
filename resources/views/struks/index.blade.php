                                    ...
                                    <form method="POST" action="{{ route('struks.updateItems', $struk->id) }}"
                                                ...
                                                <div class="flex-1 relative">
                                                    <select name="nama[]"
                                                        ...
                                                        <option value="" disabled
                                                            {{ empty($item['nama']) ? 'selected' : '' }}>Pilih Barang
                                                        </option>
                                        ...
                                        <div
                                            ...
                                            <select
                                                ...
                                                id="newItemNama" style="min-width:0">
            ...
            <form method="POST" action="" id="editItemsForm">
                ...
                <div class="border-2 border-dashed border-indigo-300 rounded-lg p-4 bg-indigo-50">
                    ...
                    <div class="grid grid-cols-12 gap-4 items-end">
                        <div class="col-span-5">
                            <select
                                class="w-full border border-gray-300 rounded-lg px-3 py-2.5 focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 bg-white"
                                id="modalNewItemNama">
                                <option value="" disabled selected>Pilih Barang</option>
                                @foreach ($barangList as $barang)
